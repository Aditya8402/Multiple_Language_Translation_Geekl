...
if prompt := st.chat_input("Enter your text to be translated"):
    ...
    response = Translation.collect_messages(prompt)                                 # Getting the response using the 'Translation.collect_messages()' function with the user's prompt as input
